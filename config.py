...
# Части для формирования строки подключения к MongoDB.
...
# Настраиваемый порядок возрастных категорий (от мягкого к строгому).
AGE_RATING_ORDER = ["G", "PG", "PG-13", "R", "NC-17"]

# Описания возрастных категорий на русском языке. Ключи — коды в БД.
